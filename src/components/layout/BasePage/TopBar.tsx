...
export function TopBar({ baseId }: TopBarProps){
  ...
  return <div className="flex flex-row shrink-0 h-14 border-b border-gray-750 bg-gray-50">
    <div className="flex flex-row items-center h-full w-[25%]">
      <div data-testid="universal-top-nav-icon-background" className="mx-2 w-8 h-8 rounded-sm bg-blue-600">
        <div className="relative my-[6px] mx-1">
          <svg width="24" height="20.4" viewBox="0 0 200 170" xmlns="http://www.w3.org/2000/svg">
            <g>
              ...
              <path fill="hsla(0, 0%, 100%, 0.95)" d="M105.3122,88.4608 L105.3122,154.0768 C105.3122,157.1978 108.4592,159.3348 111.3602,158.1848 L185.1662,129.5368 C186.8512,128.8688 187.9562,127.2408 187.9562,125.4288 L187.9562,59.8128 C187.9562,56.6918 184.8092,54.5548 181.9082,55.7048 L108.1022,84.3528 C106.4182,85.0208 105.3122,86.6488 105.3122,88.4608"></path>
      ...
      <span className="flex items-center flex-1 h-full px-2"
      onDoubleClick={() => {
